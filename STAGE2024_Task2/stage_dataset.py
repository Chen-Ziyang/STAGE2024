...
class STAGE_sub2_dataset(data.Dataset):
    """
    getitem() output:
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == "train":
            return oct_imgs, fundus_imgs, label / 40., np.array([gender[info[0]], info[1]/100., eye[info[2]], stage[info[3]]])
